...
def main():
    try:
        ...
        messages = [
            ...
            {'role': 'user','content': '''现在你模拟魔兽世界，当我和你对话时，你用以下格式输出内容：【环境】这里描写环境、角色情况、动作、表情等细节，角色名要用[]括起来，角色名不用每次都重复出现。【对话】这里以某一个角色的身份和我对话。（注意：对话中，不要以故事生成器引擎的身份、不要以旁白的视角、不要以第一人称视角、不要很啰嗦，一定要以第三人称视角，说话内容、风格要和角色吻合，明白了吗，现在我们开始。）'''},
