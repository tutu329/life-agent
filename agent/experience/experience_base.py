...
if __name__ == "__main__":
    ...
    root = Experience("咨询报告编制经验", "必要性、方案、投资估算最重要")
    exp1 = Experience("工程可研", "工程可研报告编制经验", parent=root)
    exp11 = Experience("经验1", "要有设计依据", parent=exp1)
    exp12 = Experience("经验2", "投资估算很重要", parent=exp1)

    exp2 = Experience("科技可研", "科技可研报告编制经验", parent=root)
    ...
    # 绝对路径
    node_abs = root.get_node_by_path("咨询报告编制经验/科技可研/经验2")
    ...
    # 绝对路径下add node
    root.add_node_by_path("咨询报告编制经验/科技可研/经验4", '好好休息')
    print("5) add后 (title):\n" + indent(root.get_tree_title_string(), "   "))
