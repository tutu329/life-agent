...
from redis_proxy.command.thread import Task_Worker_Thread
from tools.llm.api_client import LLM_Client

# 全局变量
# from redis_proxy.command.protocol import s_redis_proxy_server_data, s_redis_client

# def llm_servant(**arg_dict):
