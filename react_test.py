...
for _ in range(10):  # 网络不稳定，多试几次
    try:
        tokenizer = AutoTokenizer.from_pretrained("C:/Users/tutu/text-generation-webui/models/Qwen-7B-Chat-GPTQ2", trust_remote_code=True)
        generation_config = GenerationConfig.from_pretrained("C:/Users/tutu/text-generation-webui/models/Qwen-7B-Chat-GPTQ2", trust_remote_code=True)

        from auto_gptq import AutoGPTQForCausalLM

        model = AutoGPTQForCausalLM.from_quantized(
            "C:/Users/tutu/text-generation-webui/models/Qwen-7B-Chat-GPTQ2",
        ...
        #     "C:/Users/tutu/text-generation-webui/models/Qwen-7B-Chat-GPTQ2", device_map="auto", trust_remote_code=True
        # ).eval()
