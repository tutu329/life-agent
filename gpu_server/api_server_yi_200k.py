...
model_name_or_path = "D:/models/Yi-34B-200K-GPTQ"
...
inputs = tokenizer(prompt_template.format(prompt=question), return_tensors='pt').input_ids.cuda()
...
# )
#
# print(pipe(prompt_template.format(prompt=question))[0]['generated_text'])
