...
def _get_args():
    ...
    parser.add_argument(
        ...
        "--checkpoint-path",
        type=str,
        # default="D:\models\Qwen-14B-Chat",
        default="D:\models\Qwen-14B-Chat-Int4",
    ...
    match args.model_type:
        case 'qwen':
            ...
            model = AutoModelForCausalLM.from_pretrained(
                ...
                trust_remote_code=True,
                # max_memory={0: '20GiB', 1: '20GiB', 'cpu': '99GiB'},
