...
def main():
    ...
    # interpreter.chat("Plot AAPL and META's normalized stock prices") # Executes a single custom_command
...
You can install new packages with pip for python, and install.packages() for R. Try to install all necessary packages in one custom_command at the beginning. Offer user the option to skip package installation as they may have already been installed.
